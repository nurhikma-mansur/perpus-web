                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="align-content: center;" >{{ fake()->date() }}</td>
                            <td style="align-content: center;" >{{ fake()->name }}</td>
                            <td style="align-content: center;" >{{ ['P', 'L'][$i%2] }}</td>
                            <td style="align-content: center;" >{{ ['Teknik Informatika', 'Sistem Informasi', 'Farmasi'][$i%3] }}</td>
